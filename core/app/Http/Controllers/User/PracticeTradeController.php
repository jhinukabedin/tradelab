...
class PracticeTradeController extends Controller
{
    public function index()
    {
        ...
        $cryptos   = CryptoCurrency::active()->orderByRaw('`crypto_rank` = 0, `crypto_rank` ASC')->paginate(getPaginate());
        return view('Template::user.trade_practice.index', compact('pageTitle', 'cryptos'));
    }
    public function tradeNow($name)
    {
        ...
        return view('Template::user.trade_practice.trade_with', compact('pageTitle', 'currency', 'tradeSettings'));
    }
    ...
    public function log()
    {
        ...
        return view('Template::user.trade_practice.log', compact('practicesTrades', 'pageTitle'));
    }
}
