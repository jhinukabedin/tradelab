...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $widget['total_trade']          = TradeLog::where('user_id', $user->id)->tradeNotPending()->count();
        $widget['total_wining_trade']   = TradeLog::where('user_id', $user->id)->win()->count();
        $widget['total_losing_trade']   = TradeLog::where('user_id', $user->id)->loss()->count();
        $widget['total_draw_trade']     = TradeLog::where('user_id', $user->id)->draw()->count();
