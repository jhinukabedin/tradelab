...
@section('content')
    <div class="container ">
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <form action="{{ route('user.deposit.insert') }}" method="post" class="deposit-form disableSubmission">
                    @csrf
                                ...
                                <div class="row justify-content-center gy-sm-4 gy-3">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="payment-system-list p-3">
                                            <div class="deposit-info">
                                                ...
                                                <div class="deposit-info__input">
                                                    <div class="deposit-info__input-group input-group">
                                                        ...
                                                        <input type="text" class="form-control cmn--form--control amount"
                                            ...
                                            <button type="submit" class="btn cmn--btn justify-content-center w-100" disabled>
