        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form role="form" id="payment-form" class="disableSubmission" method="{{ $data->method }}"
                            action="{{ $data->url }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" class="form-control cmn--form--control"
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control cmn--form--control" name="billing-cc-exp"
                                        value="{{ old('billing-cc-exp') }}" placeholder="e.g. MM/YY" autocomplete="off"
                                        required />
                                </div>
                                <div class="col-md-6 ">
                                    <label class="form-label">@lang('CVC Code')</label>
                                    <input type="tel" class="form-control cmn--form--control" name="billing-cc-cvv"
