            ...
            <div class="col-md-8">
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" class="disableSubmission payment" id="payment-form" method="{{ $data->method }}"
                            action="{{ $data->url }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control cmn--form--control" name="name"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" class="form-control cmn--form--control" name="cardNumber"
                            ...
                            <div class="row mt-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="tel" class="form-control cmn--form--control" name="cardExpiry"
                                        value="{{ old('cardExpiry') }}" autocomplete="off" required />
                                </div>
                                <div class="col-md-6 ">
                                    <label class="form-label">@lang('CVC Code')</label>
                                    <input type="tel" class="form-control cmn--form--control" name="cardCVC"
