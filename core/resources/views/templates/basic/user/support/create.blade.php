        ...
        <div class="row justify-content-center gy-4">
            <div class="col-12">
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ticket.store') }}" method="post" class="disableSubmission" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label class="form-label">@lang('Name')</label>
                                    <input type="text" name="name" value="{{ @$user->firstname . ' ' . @$user->lastname }}"
                                        class="form-control cmn--form--control" required readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="form-label">@lang('Email Address')</label>
                                    <input type="email" name="email" value="{{ @$user->email }}" class="form-control cmn--form--control" required
                                        readonly>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="priority" class="form-control cmn--form--control select2" data-minimum-results-for-search="-1" required>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <button type="button" class="btn btn-secondary btn-sm addAttachment my-2 mb-3">
                    ...
                    <div class="col-lg-4 col-md-12 removeFileInput">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="file" name="attachments[]" class="form-control cmn--form--control" accept=".jpeg,.jpg,.png,.pdf,.doc,.docx" required>
                                <button type="button" class="input-group-text removeFile bg--danger border--danger text-white">
