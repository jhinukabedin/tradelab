                    ...
                    <form method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control" name="referral_bonus"
                                        value="{{ getAmount(gs('referral_bonus')) }}" />
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control" name="practice_balance"
                                        value="{{ getAmount(gs('practice_balance')) }}" />
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control" name="trade_profit"
                                        value="{{ getAmount(gs('trade_profit')) }}" />
                                    <span class="input-group-text">%</span>
                                </div>
                            </div>
                            <div class="form-group col-12">
                                <label class="form-control-label font-weight-bold">@lang('Coinmarketcap Api Key') </label>
                                <input class="form-control form-control-lg" type="text" name="coinmarketcap_api_key"
                                    value="{{ gs('coinmarketcap_api_key') }}">
                                <a href="https://coinmarketcap.com/" target="__blank">
                                    <small>https://coinmarketcap.com/api/</small>
                                </a>
                            </div>
                        </div>
                        <div class="form-group">
