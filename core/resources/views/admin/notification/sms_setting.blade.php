                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="sms_method" class="select2 form-control" data-minimum-results-for-search="-1">
                                <option value="clickatell" @if (@gs('sms_config')->name == 'clickatell') selected @endif>
                                    @lang('Clickatell')</option>
                                <option value="infobip" @if (@gs('sms_config')->name == 'infobip') selected @endif>@lang('Infobip')
                                </option>
                                <option value="messageBird" @if (@gs('sms_config')->name == 'messageBird') selected @endif>
                                    @lang('Message Bird')</option>
                                <option value="nexmo" @if (@gs('sms_config')->name == 'nexmo') selected @endif>@lang('Nexmo')
                                </option>
                                <option value="smsBroadcast" @if (@gs('sms_config')->name == 'smsBroadcast') selected @endif>
                                    @lang('Sms Broadcast')</option>
                                <option value="twilio" @if (@gs('sms_config')->name == 'twilio') selected @endif>@lang('Twilio')
                                </option>
                                <option value="textMagic" @if (@gs('sms_config')->name == 'textMagic') selected @endif>
                                    @lang('Text Magic')</option>
                                <option value="custom" @if (@gs('sms_config')->name == 'custom') selected @endif>@lang('Custom API')
                                </option>
                            </select>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        name="clickatell_api_key" value="{{ @gs('sms_config')->clickatell->api_key }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        name="infobip_username" value="{{ @gs('sms_config')->infobip->username }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Password')"
                                        name="infobip_password" value="{{ @gs('sms_config')->infobip->password }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="messageBird">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>@lang('API Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        name="message_bird_api_key" value="{{ @gs('sms_config')->message_bird->api_key }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="nexmo">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('API Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        name="nexmo_api_key" value="{{ @gs('sms_config')->nexmo->api_key }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Secret')"
                                        name="nexmo_api_secret" value="{{ @gs('sms_config')->nexmo->api_secret }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        ...
                                        value="{{ @gs('sms_config')->sms_broadcast->username }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Password')"
                                        ...
                                        value="{{ @gs('sms_config')->sms_broadcast->password }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Account SID')"
                                        name="account_sid" value="{{ @gs('sms_config')->twilio->account_sid }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Auth Token')"
                                        name="auth_token" value="{{ @gs('sms_config')->twilio->auth_token }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('From Number')"
                                        name="from" value="{{ @gs('sms_config')->twilio->from }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4 d-none configForm" id="textMagic">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('Username') </label>
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        name="text_magic_username" value="{{ @gs('sms_config')->text_magic->username }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Apiv2 Key')"
                                        name="apiv2_key" value="{{ @gs('sms_config')->text_magic->apiv2_key }}">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="custom_api_url"
                                            value="{{ @gs('sms_config')->custom->url }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_name[]"
                                                                class="form-control"
                                                                value="{{ @gs('sms_config')->custom->headers->name[$i] }}"
                                                                placeholder="@lang('Headers Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_header_value[]"
                                                                class="form-control"
                                                                value="{{ @gs('sms_config')->custom->headers->value[$i] }}"
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_name[]"
                                                                class="form-control"
                                                                value="{{ @gs('sms_config')->custom->body->name[$i] }}"
                                                                placeholder="@lang('Body Name')">
                                                        </div>
                                                        <div class="col-md-5">
                                                            <input type="text" name="custom_body_value[]"
                                                                value="{{ @gs('sms_config')->custom->body->value[$i] }}"
...
@push('breadcrumb-plugins')
    <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal"
        class="btn btn-outline--primary btn-sm"> <i class="las la-paper-plane"></i> @lang('Send Test SMS')</button>
@endpush
