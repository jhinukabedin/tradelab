                        ...
                        <div class="payment-method-item">
                            <div class="gateway-body">
                                <div class="gateway-thumb">
                                    <div class="thumb">
                                        <x-image-uploader drakMode="true" image="{{ $method->image }}" class="w-100" type="gateway" :required=false />
                                    </div>
                                </div>
                            ...
                            <div class="payment-method-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="submitRequired bg--warning form-change-alert d-none mt-3"><i class="fas fa-exclamation-triangle"></i>
