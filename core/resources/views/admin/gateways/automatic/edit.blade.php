                        ...
                        <div class="payment-method-item block-item">
                            ...
                            <div class="gateway-body">
                                <div class="gateway-thumb">
                                    <div class="thumb">
                                        <x-image-uploader darkMode="true" image="{{ $gateway->image }}" class="w-100" type="gateway" :required=false />
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                @foreach ($gateway->extra as $key => $param)
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        @if ($key == 'cron')
                                                            <small><i class="las la-info-circle"></i> @lang('Set the URL to your server\'s cron job to validate the payment. You can also set the cron job to the system\'s') <a href="{{ route('admin.cron.index') }}" target="_blank">@lang('Cron Job Manager')</a></small>
                                                        @endif
